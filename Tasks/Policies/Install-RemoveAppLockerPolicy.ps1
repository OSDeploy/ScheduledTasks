...
#======================================================================================
#   Task Properties
$TaskName = 'Remove-AppLockerPolicy'
$TaskPath = '\Corporate\Policies'
$Description = @"
Version 21.1.19  
Deletes all files in $env:SystemRoot\System32\AppLocker
...
if (Test-Path $env:SystemRoot\System32\AppLocker) {
    Remove-Item $env:SystemRoot\System32\AppLocker\* -Recurse -Force -ErrorAction SilentlyContinue
}
#======================================================================================
#   Complete
#======================================================================================
