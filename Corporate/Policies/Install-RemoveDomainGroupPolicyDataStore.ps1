...
#======================================================================================
#   Task Properties
$TaskName = 'Remove-DomainGroupPolicyDataStore'
$TaskPath = '\Corporate\Policies'
$Description = @"
Deletes all files in $env:SystemRoot\System32\GroupPolicy\DataStore  
...
#   Main
#======================================================================================
if (Test-Path $env:SystemRoot\System32\GroupPolicy\DataStore) {
    Remove-Item $env:SystemRoot\System32\GroupPolicy\DataStore\* -Recurse -Force -ErrorAction SilentlyContinue
}
#======================================================================================
#   Complete
#======================================================================================
