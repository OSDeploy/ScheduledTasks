...
#======================================================================================
#   Task Properties
$TaskName = 'Set Service Windows Update Manual'
$TaskPath = '\Corporate\Services'
$Description = @"
Get-Service 'Windows Update' | Set-Service -StartupType Manual -PassThru | Start-Service
...
$Action = @{
    ...
    Argument = "-ExecutionPolicy ByPass -Command `"& {Get-Service 'Windows Update' | Set-Service -StartupType Manual -PassThru | Start-Service}`""
}
$Principal = @{
